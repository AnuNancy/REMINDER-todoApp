...
import com.anuradha.todoapp.Adapters.Todo_List_Adapters;
import com.anuradha.todoapp.Interface.RecyclerViewClickListener;
import com.anuradha.todoapp.Model.TodoModel;
...
public class HomeFragment extends Fragment implements RecyclerViewClickListener {
    ...
    private void getTask() {
        ...
        String url = "https://anutodoapp.herokuapp.com/api/todo";
    ...
    private void update_task(String id, String title, String description) {
        String url = "https://anutodoapp.herokuapp.com/api/todo/"+id;
    ...
    //get all finished todo task method
    @Override
    public void onDoneButtonClick(int position) {
        showFinishedDialog(arrayList.get(position).getId(),position);
    }

    private void showFinishedDialog(final String id, final int position) {


        final AlertDialog dialog = new AlertDialog.Builder(getActivity())
                .setTitle("Moved to finished task")
                .setPositiveButton("YES",null)
                .setNegativeButton("NO",null)
                .create();
    ...
    private void updateToFinishedTodo(String id, final int position){
